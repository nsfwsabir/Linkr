 ...
 * iOS: real BlurView. Android: solid translucent (dimezisBlurView re-blurs
 * every frame during stack slides → white flash + jank).
 */
...
export function BottomNav({ state, navigation }: BottomTabBarProps) {
  ...
  const pillStyle = [
    styles.pill,
    {
      ...
      backgroundColor: dark ? 'rgba(30,33,38,0.88)' : 'rgba(255,255,255,0.92)',
