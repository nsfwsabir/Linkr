      ...
      <View style={[styles.content, { gap: v(38), paddingHorizontal: v(24) }]}>
        <View style={styles.top}>
          <Text
            style={[
              styles.wordmark,
              { fontSize: v(29), letterSpacing: v(-0.6), color: c.textPrimary },
            ]}
          >
            Linker
          </Text>
          <Text
            style={[
              styles.tag,
              { marginTop: v(8), fontSize: v(13.5), lineHeight: v(20), color: c.textSecondary },
            ]}
          >
        ...
        {error ? (
          <Text style={[styles.error, { fontSize: v(12) }]}>{error}</Text>
        ) : null}
      </View>
      <Text
        style={[
...
const styles = StyleSheet.create({
  ...
  wordmark: { fontWeight: '800', textAlign: 'center' },
